  ...
  return (
    <div className={styles.wrapper}>
      <div className={styles.back}>
        <img src="src/pages/Profile/images/back-btn.svg" alt="back" />
      </div>

      <div className={styles.avatarContainer}>
        <img src={avatarImage} className={styles.avatar} alt="avatar" />

        <div className={styles.rating}>
          <img src="src/pages/Profile/images/rating.svg" alt="rating" />
